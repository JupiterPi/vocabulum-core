...
public class WordbaseNoun extends Noun {
    ...
    public WordbaseNoun(String baseForm, Gender gender, Document forms) {
    ...
    public static WordbaseNoun readFromDocument(Document document) {
        return new WordbaseNoun(document.getString("base_form"), Gender.valueOf(document.getString("gender").toUpperCase()), (Document) document.get("forms"));
    }
